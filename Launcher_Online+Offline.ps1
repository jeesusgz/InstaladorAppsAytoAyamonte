<#
    LAUNCHER AYTO AYAMONTE - Prototipo v3
    ---------------------------------
    Novedad: pantalla ONLINE / OFFLINE antes de departamentos.
      - ONLINE  -> instala vía winget (necesita internet)
      - OFFLINE -> instala desde instaladores locales (pen/carpeta), sin internet
...
# ------------------- CONFIGURACIÓN -------------------
$MODO_REAL   = $false   # Cambiar a $true cuando esté probado en un equipo real
...
$script:ModoActual = $null     # "online" u "offline", se fija al elegir
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Aplicaciones - Ayuntamiento de Ayamonte (v6.5)"
    ...
    <Grid>
        ...
        <Border Grid.Row="0" Background="#141414">
            <DockPanel LastChildFill="True" Margin="15,0,15,0">
                ...
                <StackPanel Orientation="Horizontal" HorizontalAlignment="Right"
                    ...
                    <TextBlock x:Name="TxtModo" Foreground="#F09595" FontSize="13"
                               VerticalAlignment="Center" Margin="0,0,15,0"/>
                    <Button x:Name="BtnVolver" Content="&#8592; Departamentos"
                            Width="150" Height="35" Margin="5,0,0,0"
                            Visibility="Collapsed"/>
                    <Button x:Name="BtnCambiarModo" Content="&#8592; Cambiar modo"
                            Width="150" Height="35" Margin="5,0,0,0"
                            Visibility="Collapsed"/>
                </StackPanel>
            </DockPanel>
        ...
        <Grid x:Name="PanelContenido" Grid.Row="1" Margin="20">
            ...
            <!-- Panel de modo (ONLINE / OFFLINE) -->
            <StackPanel x:Name="PanelModo" HorizontalAlignment="Center"
                        VerticalAlignment="Center" Orientation="Vertical">
                <TextBlock Text="¿Cómo quieres instalar?" FontSize="20" FontWeight="Bold"
                           Foreground="#f0f0f0"
                           HorizontalAlignment="Center" Margin="0,0,0,20"/>
                <StackPanel Orientation="Horizontal" HorizontalAlignment="Center">
                    <Button x:Name="BtnOnline" Content="🌐&#10;ONLINE&#10;(necesita internet)"
                            Width="220" Height="130" Margin="15" FontSize="16"
                            Background="#141414" Foreground="White"/>
                    <Button x:Name="BtnOffline" Content="💾&#10;OFFLINE&#10;(desde este pen)"
                            Width="220" Height="130" Margin="15" FontSize="16"
                            Background="#232323" Foreground="#f0f0f0" BorderBrush="#E24B4A" BorderThickness="2"/>
                </StackPanel>
            </StackPanel>
...
$PanelModo          = $Window.FindName("PanelModo")
$BtnOnline          = $Window.FindName("BtnOnline")
...
$BtnCambiarModo     = $Window.FindName("BtnCambiarModo")
...
# Elige el modo (online/offline) y pasa a la pantalla de departamentos
function global:Elegir-Modo($modo) {
    $script:ModoActual = $modo
    $TxtModo.Text = "Modo: " + $(if ($modo -eq "online") { "🌐 ONLINE" } else { "💾 OFFLINE" })

    $PanelModo.Visibility = "Collapsed"
    $PanelDepartamentos.Visibility = "Visible"
    $BtnCambiarModo.Visibility = "Visible"
    Set-Estado "Modo elegido: $modo. Selecciona un departamento."
}

function global:Volver-A-Modo() {
    $script:ModoActual = $null
    $TxtModo.Text = ""
    $ScrollProgramas.Visibility = "Collapsed"
    $PanelDepartamentos.Visibility = "Collapsed"
    $BtnVolver.Visibility = "Collapsed"
    $BtnCambiarModo.Visibility = "Collapsed"
    $PanelModo.Visibility = "Visible"
    Set-Estado "Selecciona un modo para empezar."
}
...
# ------------------- EVENTOS DE MODO -------------------
$BtnOnline.Add_Click({ Elegir-Modo "online" })
$BtnOffline.Add_Click({ Elegir-Modo "offline" })
$BtnCambiarModo.Add_Click({ Volver-A-Modo })
...
function global:Unir-Al-Dominio() {
    ...
    $nuevoNombre = [Microsoft.VisualBasic.Interaction]::InputBox(
        ...
        "Unir al dominio",
        $env:COMPUTERNAME)
    if (-not $nuevoNombre) { return }   # cancelado
    ...
    if (-not $credenciales) { return }   # canceló el cuadro de credenciales
